...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      project_pivot_decisions: {
        Row: {
          biases_identified: string[]
          completed_at: string | null
          confidence_assessment: Json | null
          ...
          external_advisors_consulted: string[]
          hypothesis_tested: Json | null
          id: string
          ...
          next_actions: string[]
          pain_points: Json
          pivot_readiness: Json | null
          pre_mortem_insights: string[]
          product_market_fit: Json | null
          project_id: string
          recommended_pivot_type: string | null
          reframing_responses: Json
          retention_metrics: Json | null
        ...
        Relationships: [
          {
            foreignKeyName: "project_pivot_decisions_iteration_id_fkey"
            columns: ["iteration_id"]
            isOneToOne: false
            referencedRelation: "project_iterations"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "project_pivot_decisions_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
